...
\begin{document}
{
    \noindent{\large{\textbf{Lourens Willekes}}} \hfill lourw95@gmail.com
    ...
    \noindent Bachelor of Science in Engineering; Computer Engineering \hfill GPA: 3.96

    \vspace{\baselineskip}
    \noindent\textbf{Coursework} - System Programming; Data Structures and Algorithms; Operating
    Systems Concepts; Embedded System Design; Design of Microcontroller Applications

    \noindent\textbf{Skills} - C/C++; CAmkES; Python; Java; Git/SVN; Linux/Unix; seL4
